...
export const assessmentsData = [
  ...
  },
  {
    ...
    description: 'Practice exponents, standard form, percentages, fractions, and substitution with integers.',
    topics: ['Exponents', 'Standard Form', 'Percentages'],
    topicIds: ['number'],
    questionCount: 5,
    time: '15',
    marks: 5,
    difficulty: 2,
    href: 'assessments/myp4-number.html',
    category: 'myp4',
    badge: 'MYP4',
    icon: '🔢',
    iconBg: 'math',
  ...
  },
  {
    ...
    description: 'Solve linear equations, factorise quadratics, simplify algebraic fractions, expand brackets, and work with inequalities.',
    topics: ['Equations', 'Factorisation', 'Inequalities'],
    topicIds: ['algebra'],
    questionCount: 7,
    time: '20',
    marks: 7,
    difficulty: 3,
    href: 'assessments/myp4-algebra.html',
    category: 'myp4',
    badge: 'MYP4',
    icon: '𝑥𝑦',
    iconBg: 'math',
  ...
  },
  {
    ...
    description: 'Apply Pythagoras, area/volume formulas, interior angles, trigonometry ratios, and composite shapes.',
    topics: ['Pythagoras', 'Area/Volume', 'Angles'],
    topicIds: ['geometry'],
    questionCount: 8,
    time: '25',
    marks: 8,
    difficulty: 3,
    href: 'assessments/myp4-geometry.html',
    category: 'myp4',
    badge: 'MYP4',
    icon: '△',
    iconBg: 'math',
